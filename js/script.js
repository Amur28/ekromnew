...
const promoHintButton = document.querySelector('.promo-hint-button');

if (promoHintButton) {
    const close = promoHintButton.querySelector('.close-btn');
    promoHintButton.addEventListener('click', function(e) {
        let target = e.target;
